  ...
  Future<void> _uploadArtwork() async {
    ...
    try {
      ...
      if (_selectedMediaType == 'video' && _selectedThumbnailFile != null) {
        ...
        final thumbName =
            '${user.id}_thumb_${DateTime.now().millisecondsSinceEpoch}.$thumbExt';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // AI Detector Warning - Glass Card
                  FadeInAnimation(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'Sistem kami secara otomatis mendeteksi karya yang dihasilkan oleh AI (Artificial Intelligence).',
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'Karya yang terindikasi AI akan ditandai dan melalui proses review lebih ketat oleh admin.',
                                            style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                              color: Colors.white.withOpacity(0.95),
                                              height: 1.5,
                                            ),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'Pastikan karya yang Anda unggah adalah hasil karya asli dan bukan dari generator AI.',
                                            style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                              color: Colors.white.withOpacity(0.95),
                                              height: 1.5,
                  ...
                  // Buttons to pick image or video - Glass Style
                  FadeSlideAnimation(
