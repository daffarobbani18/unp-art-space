                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const InspirasiDuniaPage()),
                      );
                    },
                    child: ClipRRect(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, idx) {
                          ...
                          final avatarUrl = talent['profile_image_url'] as String?;
                          
                          return GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => ArtistDetailPage(artistId: talent['id'])),
                            ),
                            child: Column(
                              children: [
                                ClipOval(
